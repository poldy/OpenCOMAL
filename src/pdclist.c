...
PRIVATE void    list_explist(char **buf, struct exp_list *exproot,
                             int parens);
...
PRIVATE void
list_text(char **buf, const char *txt)
{
    strcpy(*buf, txt);
    (*buf) += strlen(txt);
}
...
PRIVATE void
list_comma(char **buf, int *first, char c)
{
    if (!*first) {
        list_char(buf, c);
        list_char(buf, ' ');
...
PRIVATE void
list_idlist(char **buf, struct id_list *root)
{
    int             first = 1;
...
PRIVATE void
list_twoexp(char **buf, struct two_exp *twoexp, const char
            *inter, int compuls)
{
    /*
...
PRIVATE void
list_rnd(char **buf, struct expression *exp)
{
    list_sym(buf, rndSYM);
...
PRIVATE void
list_get(char **buf, struct expression *exp)
{
    list_sym(buf, getSYM);
    list_char(buf, '(');
    list_exp(buf, exp->e.twoexp.exp1);
...
PUBLIC void
list_exp(char **buf, struct expression *exp)
{
    char            cvtbuf[64];
...
PRIVATE void
list_expsp(char **buf, struct expression *exp)
{
    list_exp(buf, exp);
    list_char(buf, ' ');
}
...
PRIVATE void
list_explist(char **buf, struct exp_list *exproot, int parens)
{
    int             first = 1;
...
PRIVATE void
list_repeat(char **buf, struct comal_line *line)
{
...
PRIVATE void
list_ifwhile(char **buf, int thendosym, struct comal_line
             *line)
{
    list_symsp(buf, line->cmd);
...
PRIVATE void
list_dim(char **buf, struct comal_line *line)
{
...
PRIVATE void
list_file(char **buf, struct two_exp *twoexp)
{
...
PRIVATE void
list_at(char **buf, struct two_exp *twoexp)
{
...
PRIVATE void
list_for(char **buf, struct comal_line *line)
{
...
PRIVATE void
list_input(char **buf, struct comal_line *line)
{
...
PRIVATE void
list_printlist(char **buf, struct print_list *printroot)
{
    while (printroot) {
        if (printroot->pr_sep)
...
PRIVATE void
list_using(char **buf, struct expression *using_modifier)
{
...
PRIVATE void
list_print(char **buf, struct comal_line *line)
{
...
PRIVATE void
list_assign(char **buf, struct comal_line *line)
{
...
PRIVATE void
list_parms(char **buf, struct parm_list *root)
{
    int             first = 1;
...
PRIVATE void
list_import(char **buf, struct comal_line *line)
{
...
PRIVATE void
list_whenlist(char **buf, struct when_list *whenroot)
{
    int             first = 1;
...
PRIVATE void
list_pf(char **buf, struct comal_line *line)
{
...
PRIVATE void
list_horse(char **buf, struct comal_line *line)
{
    if (!line)
        return;
...
PUBLIC void
line_list(char **buf, struct comal_line *line)
{
    if (!line) {
