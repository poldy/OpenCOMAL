...
0.2.7:
	...
	- Added the STATIC command (also see "whitepaper1.txt".)
        - Ported to macOS
        - The following changes were made to aligh better with Common COMAL:
	...
	- Added samples/examples/standard.lst
	- Temporarily removed support for MS-DOS and Win32, because I can't
	  ...
	  sent in a pull request (git tag "last_dos_w32_version" is the
